...
#ifndef BRAVE_COMPONENTS_BRAVE_WALLET_BROWSER_SOLANA_TX_SERVICE_H_
#define BRAVE_COMPONENTS_BRAVE_WALLET_BROWSER_SOLANA_TX_SERVICE_H_
...
class SolanaTxService : public TxService {
 public:
  SolanaTxService(TxServiceManager* tx_service_manager,
                  JsonRpcService* json_rpc_service,
                  KeyringService* keyring_service,
                  PrefService* prefs);
  ~SolanaTxService() override = default;
...
#endif  // BRAVE_COMPONENTS_BRAVE_WALLET_BROWSER_SOLANA_TX_SERVICE_H_
