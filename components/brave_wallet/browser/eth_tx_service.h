...
class EthTxService : public TxService,
 ...
 public:
  ...
  using MakeERC20TransferDataCallback =
      mojom::EthTxServiceProxy::MakeERC20TransferDataCallback;
  using MakeERC20ApproveDataCallback =
      mojom::EthTxServiceProxy::MakeERC20ApproveDataCallback;
  using MakeERC721TransferFromDataCallback =
      mojom::EthTxServiceProxy::MakeERC721TransferFromDataCallback;
  using SetGasPriceAndLimitForUnapprovedTransactionCallback = mojom::
      EthTxServiceProxy::SetGasPriceAndLimitForUnapprovedTransactionCallback;
  using SetGasFeeAndLimitForUnapprovedTransactionCallback = mojom::
      EthTxServiceProxy::SetGasFeeAndLimitForUnapprovedTransactionCallback;
  using SetDataForUnapprovedTransactionCallback =
      mojom::EthTxServiceProxy::SetDataForUnapprovedTransactionCallback;
  using SetNonceForUnapprovedTransactionCallback =
      mojom::EthTxServiceProxy::SetNonceForUnapprovedTransactionCallback;
  using GetNonceForHardwareTransactionCallback =
      mojom::EthTxServiceProxy::GetNonceForHardwareTransactionCallback;
  using ProcessHardwareSignatureCallback =
      mojom::EthTxServiceProxy::ProcessHardwareSignatureCallback;
  using GetGasEstimation1559Callback =
      mojom::EthTxServiceProxy::GetGasEstimation1559Callback;
